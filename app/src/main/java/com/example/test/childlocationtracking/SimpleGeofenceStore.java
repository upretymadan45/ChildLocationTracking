...
import static com.example.test.childlocationtracking.Constants.INVALID_FLOAT_VALUE;
import static com.example.test.childlocationtracking.Constants.INVALID_INT_VALUE;
import static com.example.test.childlocationtracking.Constants.INVALID_LONG_VALUE;
import static com.example.test.childlocationtracking.Constants.KEY_EXPIRATION_DURATION;
import static com.example.test.childlocationtracking.Constants.KEY_LATITUDE;
import static com.example.test.childlocationtracking.Constants.KEY_LONGITUDE;
import static com.example.test.childlocationtracking.Constants.KEY_PREFIX;
import static com.example.test.childlocationtracking.Constants.KEY_RADIUS;
import static com.example.test.childlocationtracking.Constants.KEY_TRANSITION_TYPE;
